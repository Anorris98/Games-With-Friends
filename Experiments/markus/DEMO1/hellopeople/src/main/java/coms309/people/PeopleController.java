...
public class PeopleController {
    ...
    //get all last names sorted (tried to use adaptive return codes for same request)
    @GetMapping("/lastnames/sorted")
    public ResponseEntity<List<String>> getLastnamesSortedAlphabetically() {
        List<String> sortedLastNames = peopleList.values().stream()
